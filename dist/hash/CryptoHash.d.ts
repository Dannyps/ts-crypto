 ...
 */
export declare const enum CryptoHashAlgorithm {
...
export declare class CryptoHash implements ICryptoHash {
    /**
     ...
     */
    static verify(content: ICoreBuffer, hash: ICoreBuffer, algorithm: CryptoHashAlgorithm): Promise<boolean>;
    /**
     ...
     */
    static hash(content: ICoreBuffer, algorithm: CryptoHashAlgorithm): Promise<CoreBuffer>;
    /**
     ...
     */
    static sha256(content: string, hash?: string): Promise<string | boolean>;
    /**
     ...
     * true or false, depending if the hashes match or not).
     */
    static sha512(content: string, hash?: string): Promise<string | boolean>;
}
